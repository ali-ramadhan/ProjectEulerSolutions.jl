...
if Sys.total_memory() >= 24 * 1024^3
    ...
    @warn "Skipping benchmark `longest_collatz_under_100M`: requires at least 24 GiB RAM (found $(round(Sys.total_memory() / 1024^3, digits=1)) GiB)"
end
