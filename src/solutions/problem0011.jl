...
Solution description: https://aliramadhan.me/blog/project-euler/problem-0011/
"""
module Problem0011

export GRID, DIRECTIONS, find_greatest_product, solve
...
function solve()
    return find_greatest_product(GRID)
end
